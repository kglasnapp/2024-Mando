...
public class Config {
    ...
    public enum RobotType {
        MiniSRX, MiniFast, Competition, Sibling, Kevin, Attila, Mando
    };

    // TODO need to change on real mando
    public boolean testKagMini = false;

    // Type of Robot
    public static RobotType robotType = RobotType.Mando;
    ...
    public int shooterID = 6;
    public int shooterFollowID = 7;
